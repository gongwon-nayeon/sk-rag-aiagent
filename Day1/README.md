...
| 13:40–14:30 | [실습] LangGraph 노드·엣지 연결 / 조건부 엣지 | 실습 | `04_langgraph_nodes_edges.ipynb` | - 순차 노드 연결 (다단계 워크플로우)<br>- 다중 노드 간 상태 전달<br>- 조건부 엣지 (add_conditional_edges)<br>- 상태 기반 분기 처리<br>- 다단계 번역 시스템 실습<br>- 사용자 의도 기반 응답 시스템 실습 |
| 14:30–14:40 | ☕ Break |  | - |  |
